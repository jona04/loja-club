...
- **Global desde a base** (`P0-MOD-05`): dinheiro é sempre `(valor + moeda ISO 4217)`; telefone/endereço/locale globais. Telefone normalizado por lib (`phonenumbers`) para qualquer país — convenção já no [doc 23](../../concepts/23_customer_identity_and_guest_checkout.md); endereço país-aware (ISO 3166) vem na Fase 6.
