...
- **— nenhum item aberto.** Varrido em 2026-06: os deferrals da fase (build da imagem do `worker` em `P0-CFG-04`; deploy e execução do CI ao vivo em `P0-CI-01`) já são **escopo das Fases 5–6**, então não entram aqui.
