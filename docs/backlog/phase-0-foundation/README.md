...
| [P0-MOD-05](./P0-MOD-05-shared-money-locale.md) | Tipos globais: Money/Currency, locale, UTC | todo | P0-MOD-01 |
| [P0-CI-01](./P0-CI-01-ci-lint-tests.md) | CI, lint, testes e client OpenAPI | todo | P0-MOD-03, P0-MOD-04 |

## Ordem sugerida de execução

```text
P0-CFG-01 → P0-CFG-02 → P0-CFG-03 → P0-CFG-04 → P0-MOD-01 → P0-MOD-05 → P0-MOD-02 → P0-MOD-03 → P0-MOD-04 → P0-CI-01
```
...
- **Global desde a base** (`P0-MOD-05`): dinheiro é sempre `(valor + moeda ISO 4217)`; telefone/endereço/locale globais (telefone E.164 p/ qualquer país, endereço país-aware ISO 3166). O [doc 23](../../23_customer_identity_and_guest_checkout.md), hoje BR-cêntrico no telefone, será generalizado no doc de Fundações / Fase 4.
