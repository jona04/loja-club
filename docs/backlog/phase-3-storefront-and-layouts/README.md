...
- [ ] **Produto: variações + disponibilidade + relacionados** (`P3-SF-01`/`P3-SF-02`): doc 10 §"Página de produto" — backend retornar variações/estoque + vitrine exibir/selecionar (hoje só imagem/nome/preço/descrição). → **Fase 7, Etapa 8** (seleção de variação na vitrine; veio da Fase 6).
