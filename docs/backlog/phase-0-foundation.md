...
- `account_users.is_superuser` (template) ↔ admin de plataforma: no MVP o superuser cobre o acesso interno; `platform_admin_roles`/`platform.*` entram na Fase 6. Registrado em [P0-MOD-04](./phase-0-foundation/P0-MOD-04-accounts-user.md).
