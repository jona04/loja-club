...
- [ ] **e2e/smoke do storefront** (vitrine reflete `theme.settings`) → **`P3-SF-03`** (E2E do storefront, Playwright): storefront sem infra de e2e ainda; a API é coberta por integração (backend) + render type-validado (`tsc`/`next build`). Origem: `P5-SF-01`.
