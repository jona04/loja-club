...
### Projeto + roteamento (doc [05](../concepts/05_frontend_architecture.md)/[06](../concepts/06_multitenancy_and_domains.md)/[12](../concepts/12_aws_infrastructure_and_deployment.md))
...
### Módulo `platform_admin` + papéis globais (doc [08](../concepts/08_modules_and_permissions.md)/[07](../concepts/07_database_strategy.md))
...
### Lojas / pedidos (doc [09](../concepts/09_merchant_dashboard.md)/[25](../concepts/25_platform_admin.md))
...
### Usuários (doc [08](../concepts/08_modules_and_permissions.md)/[14](../concepts/14_security_strategy.md))
...
### Planos (stub) (doc [02](../concepts/02_business_model_and_rules.md)/[08](../concepts/08_modules_and_permissions.md))
...
> O **`settings_schema`** de um template **vem do código** (manifesto exportado pelo template React, seedado no DB ao fazer deploy) — doc [26](../concepts/26_template_system.md). O admin **não edita os campos**: ele sobe **o thumbnail**, ajusta **metadados** e **ativa**.

### CRUD + thumbnail + schema (doc [26](../concepts/26_template_system.md)/[13](../concepts/13_performance_cache_and_cdn.md))
...
> **Loja-demo por template, import das imagens (chrome/demo) pro CDN e preview navegável** são a **[Fase 5](./phase-5-store-configuration.md)** — ver doc [26](../concepts/26_template_system.md)/[27](../concepts/27_template_authoring_guide.md).
...
- **Schema vem do código** (manifesto), não é autorado no admin — evita divergência schema↔código (doc [26](../concepts/26_template_system.md)). O admin sobe assets + ativa.
- **Assets no CDN** acabam com o hardcoded de `public/` e as URLs temporárias (decisões docs [25](../concepts/25_platform_admin.md)/[26](../concepts/26_template_system.md)).
