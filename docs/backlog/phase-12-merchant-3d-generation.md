...
Docs de referência: [22](../concepts/22_product_customization_3d.md), [18](../concepts/18_open_decisions.md), [07](../concepts/07_database_strategy.md), [13](../concepts/13_performance_cache_and_cdn.md), [14](../concepts/14_security_strategy.md), [09](../concepts/09_merchant_dashboard.md), [16](../concepts/16_testing_strategy.md).
...
- O lojista **mapeia a área personalizável** (e limites) do modelo gerado **pelo painel** (sem depender do dev/seed).
...
- [ ] Persistir o GLB **por loja** (S3) e servir por CDN. Reaproveita `app/core/storage.py` (Fase 2).
...
- [ ] Editor no painel pra o lojista **definir a área imprimível** + limites (cor/texto/escala) sobre o GLB gerado — a config que, no catálogo da plataforma, vinha do seed.
